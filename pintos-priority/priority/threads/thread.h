...
bool thread_priority_donate_cmp (const struct list_elem *a, const struct list_elem *B, void *aux UNUSED);
void priority_donate (void);
void release_lock_remove (struct lock *lock);
